...
|--------|--------|---------------|
| 🗓️ Timing optimal | Les mois de **mars, septembre et octobre** affichent les meilleurs taux de conversion | +XX% vs moyenne |
...
| 💰 ROI par segment | Le segment "score élevé" représente XX% des contacts pour XX% des conversions | Optimisation budget |
